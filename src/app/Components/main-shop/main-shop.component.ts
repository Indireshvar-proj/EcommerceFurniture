  ...
  getProductFilteration() {
    this.prdService.getProductsFilteration(this.productsSearchModel.toString()).subscribe(
      response => {
        ...
        this.highValue = this.productsSearchModel.maxPrice <= 0 ? this.options.ceil : this.productsSearchModel.maxPrice;
        this.value = this.productsSearchModel.minPrice == 0 ? this.options.floor : this.productsSearchModel.minPrice;
      }
    );
    console.log(this.productsSearchModel.toString());
  }
